...
#The data frames will contain the predictions of the base models.
...
[auc,predict_XGB]=cross_validation('Gradient Boosting',model_stack['Stack'],xgb.DMatrix(dstack_X,label=test_Y),test_Y)
metric_stack=(auc)    
